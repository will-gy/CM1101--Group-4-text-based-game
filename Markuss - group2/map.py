...
room_cell_a = {
    ...
    "description": """ There are dripping noises echoing throughout the cell and lots 
...
a small window. From your knowledge theres an exit south that leads 
to the Kitchen and a Cleaning Closet to the east. But you also notice 
a mysterious door to the west.""",
...
be taken from the cell. You know that to the west there's a Cleaning Closet, 
...
room_closet = {
    ...
    "description":
    """You step into the small cleaning closet and its full of cleaning products and equipment. 
...
room_shower = {
    ...
    heads is a bar of soap. From here you can head north towards Cell B, 
    west to the Kitchen or south out to the Courtyard.""",
